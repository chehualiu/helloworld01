...
def construct_mpf_collections(ptype,dates,xdates,opens,highs,lows,closes,volumes,config,style):
    collections = None
    if ptype == 'candle' or ptype == 'candlestick':
        ...
        collections = construct_renko_collections(
...
def _construct_ohlc_collections(dates, opens, highs, lows, closes, marketcolors=None, config=None):
    ...
    *opens*, *highs*, *lows* and *closes* must have the same length.
    ...
    ticksize = 1#config['_width_config']['ohlc_ticksize']
    ...
    lw = 0.5#config['_width_config']['ohlc_linewidth']
...
def _construct_candlestick_collections(dates, opens, highs, lows, closes, marketcolors=None, config=None):
    ...
    delta = 0.5#config['_width_config']['candle_width'] / 2.0
    ...
    lw = 0.5#config['_width_config']['candle_linewidth']
...
def construct_hollow_candlestick_collections(dates, opens, highs, lows, closes, marketcolors=None, config=None):
...
def construct_renko_collections(dates, highs, lows, volumes, config_renko_params, closes, marketcolors=None):
